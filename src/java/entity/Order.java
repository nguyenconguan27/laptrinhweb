...
public class Order {
    ...
    public Order(int oID, int accID, String address, String phone,int isOrdered, Date date) {
        this.oID = oID;
        this.accID = accID;
    ...
    public String toString() {
        return "Order{" + "oID=" + oID + ", accID=" + accID + ", address=" + address + ", phone=" + phone + ", isOrdered=" + isOrdered + ", date=" + date + ", detail=" + detail + '}';
    }
