...
public class OrderDao {
    ...
    public void addOrder(int accID, String address, String phone){
        String query = "insert into [Order](accID, [address], phone) values(?, ?, ?)";
        try{
            Connection con = new DBcontext().getConnection();
            PreparedStatement ps = con.prepareStatement(query);
            ps.setInt(1, accID);
    ...
    public Order getOrder(int accID){
        ...
        try{
            ...
            ResultSet rs = ps.executeQuery();
            rs.next();
            Order order = new Order(rs.getInt(1), rs.getInt(2), rs.getString(3), rs.getString(4),rs.getInt(5), rs.getDate(6));
            return order;
        }
        catch(Exception e){
    ...
    public ArrayList<OrderDetail> getOrderedtDetail(int accID){
        String query = "select OrderDetail.*, Product.name, Product.image, Product.price, Product.sellID from OrderDetail\n"
                + "inner join [Order] on OrderDetail.oID = [Order].oID\n"
                + "inner join Product on OrderDetail.pID = Product.id\n"
                + "where [Order].accID = ? and [Order].ordered = 1 and OrderDetail.[status] != 2 and OrderDetail.[status] != 3";
        try{
            Connection con = new DBcontext().getConnection();
            PreparedStatement ps = con.prepareStatement(query);
            ps.setInt(1, accID);
    ...
    public void updateOrderStatus(int oID, String address, String phone){
        String query = "update [Order] set ordered = 1, [date] = getdate(), [address] = ?, [phone] = ? where oID = ?";
        try{
            Connection con = new DBcontext().getConnection();
            PreparedStatement ps = con.prepareStatement(query);
    ...
    public void updateOrder1(int oID){
        String query = "update [Order] set ordered = 2 where oID = ? and ordered = 0";
        try{
            Connection con = new DBcontext().getConnection();
            PreparedStatement ps = con.prepareStatement(query);
            ps.setInt(1, oID);
    ...
    public ArrayList<OrderDetail> getOrderToSeller(int sellID){
        String query = "select OrderDetail.*, Product.name, Product.image, Product.price, Product.sellID, Account.[user], [Order].phone, [Order].[address] from OrderDetail\n"
                + "inner join Product on OrderDetail.pID = Product.id\n"
    ...
    public void recievedOrder(int oID, int pID){
        String query = "update OrderDetail set [status] = 2 where oID = ? and pID = ?";
        try{
           Connection con = new DBcontext().getConnection();
            PreparedStatement ps = con.prepareStatement(query);
            ps.setInt(1, oID);
    ...
    public void finishOrder(int oID, int pID){
        String query = "update OrderDetail set [status] = 3 where oID = ? and pID = ?";
        try{
           Connection con = new DBcontext().getConnection();
            PreparedStatement ps = con.prepareStatement(query);
            ps.setInt(1, oID);
    ...
    public ArrayList<OrderDetail> getHistory(int accID){
        String query = "select OrderDetail.*, Product.name, Product.image, Product.price, Product.sellID from OrderDetail\n"
                + "inner join [Order] on OrderDetail.oID = [Order].oID\n"
                + "inner join Product on OrderDetail.pID = Product.id\n"
                + "where [Order].accID = ? and OrderDetail.[status] = 2";
        try{
            Connection con = new DBcontext().getConnection();
            PreparedStatement ps = con.prepareStatement(query);
            ps.setInt(1, accID);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(dao.getHistory(4));
    }
}
