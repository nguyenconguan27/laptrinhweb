                            ...
                            <div class="card">
                                <div class="row">
                                    <aside class="col-sm-5 border-right">
                                        ...
                                        <div>
                                            <h3 class="list-group-item text-white"><button type="button" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16">
                                                    ...
                                                    </svg><a style="color: white; margin-left: 10px;" href="seller?sellID=${seller.id}">${seller.user}</a></button></h3>
                                        </div> 
                                    </article> 
                                </aside>
                                <aside class="col-sm-7">
                                    <article class="card-body p-5">
                                        ...
                                        <form action="addtocart?pid=${p.id}" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5">
                                                    <input name="quantity" style="width:70px; text-align: center;"  value="1" type="text">
                                                </div>
                                            </div>
                                            <hr>
